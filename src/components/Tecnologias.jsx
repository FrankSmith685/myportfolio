        ...
        <div className="flex flex-nowrap h-full">
                ...
                <div className="w-5/6  h-full">
                    <div className="text-center">
                        <span className="text-4xl font-bold font-serif  text-white">Tecnologías</span>
                    </div>
                    <div>
                        <p className="text-white text-lg">Algunas de las tecnologías que manejo y utilizo para crear aplicaciones:</p>
                    </div>
                    <div className="flex flex-nowrap mt-4  h-auto">
                        <div className="w-1/4  bg-gray-700 h-auto text-center border-2 border-white rounded-3xl m-1">
                    ...
                    <div>
                        <p className="text-white text-lg pt-5">Actualmente estoy aprendiendo nuevas tecnologías como:</p>
                    </div>
                    <div className="flex flex-nowrap   h-auto">
                        <div className="w-1/4  bg-gray-700 h-auto text-center border-2 border-white rounded-3xl m-1">
                            <div className="flex justify-center items-center py-2">
