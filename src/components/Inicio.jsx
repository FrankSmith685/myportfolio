            ...
            <div className="flex flex-nowrap h-full bg-primary">
                <div className="w-1/6 ">
                    <div className="flex items-center absolute h-full"> 
                        <div className="fixed w-auto text-white  h-auto">
                            ...
                            <div className="flex items-center border-none bg-blue-600 p-2 relative -left-24 top-0 hover:left-0 transition-all duration-300 ease-linear hover:cursor-pointer">
                ...
                <div className="w-5/6">
                    <div className="flex items-center h-full">
                        ...
                        <span className="text-orange-600 font-bold font-serif text-xl md:text-4xl pr-3">¡Hola Mundo! </span><img className="w-7 md:w-10" src={images} alt="" /><span className="text-yellow-600 pl-3 font-bold font-serif text-lg md:text-4xl">Soy Frank Smith</span>
                        </div>
                        <div>
